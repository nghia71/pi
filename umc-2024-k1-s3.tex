...
\begin{frame}[t]
    ...
    \end{example}
    \begin{overprint}
        \onslide<2>First, we prove a minor claim:
        ...
        \begin{center}
            \includegraphics[width=4cm]{../Learning-Problem-Solving-2nd-Edition/asy/pdf/imo-1972-2-1.pdf}
        \end{center}
        ...
        \onslide<3>By the claim, first the given cyclic quadrilateral can be divided into four cyclic quadrilaterals.
        \begin{center}
            \includegraphics[width=4cm]{../Learning-Problem-Solving-2nd-Edition/asy/pdf/imo-1972-2-1.pdf}
        \end{center}
...
\begin{frame}[t]
    ...
    \end{example}
    \begin{overprint}
        \onslide<2>WLOG, \textit{assume that $AB\ldots$ is the convex hull} of all $n$ given points.
        Now, since no three points collinear, there exists a point $C$, such that for all other points $D_1,\ldots,D_{n-3}$,
        \begin{center}
            \includegraphics[width=3.5cm]{../Learning-Problem-Solving-2nd-Edition/asy/pdf/imo-1969-5-1.pdf}
            \quad
            \includegraphics[width=3.5cm]{../Learning-Problem-Solving-2nd-Edition/asy/pdf/imo-1969-5-2.pdf}
        \end{center}
        \[ 
        ...
        \onslide<3>Consider any two distinct points $P_i,P_j$, $i,j \in \{ 1,\ldots, n-3 \}.$
        \begin{center}
            \includegraphics[width=3.3cm]{../Learning-Problem-Solving-2nd-Edition/asy/pdf/imo-1969-5-1.pdf}
            \quad
            \includegraphics[width=3.3cm]{../Learning-Problem-Solving-2nd-Edition/asy/pdf/imo-1969-5-2.pdf}
        \end{center}
...
\begin{frame}[t]
    ...
    \end{example}
    \begin{overprint}
        \onslide<2>Lets prove by induction. For $n=1$ it is obvious. Assume that the hypothesis is true for $n$. 
        WLOG, \textit{assume that $A_1A_2\ldots A_m$ is the convex hull} of $A_1,A_2, \ldots, A_{3n+3}$ given points.
        \begin{center}
            \includegraphics[width=4cm]{../Learning-Problem-Solving-2nd-Edition/asy/pdf/imo-sl-1972-2-1.pdf}
        \end{center}
        Since no three points collinear,
        $\exists A_i,\ \angle A_iA_1A_2 = \min \{ \angle A_kA_1A_2 \mid \forall k \in \{ 3,\ldots, 3n+3 \} \}.$
        \onslide<3>The line through $A_1A_2$ divides the plane into two separate half-planes.
        \begin{center}
            \includegraphics[width=4cm]{../Learning-Problem-Solving-2nd-Edition/asy/pdf/imo-sl-1972-2-1.pdf}
        \end{center}
