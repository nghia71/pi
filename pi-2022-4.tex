...
\begin{exercise*}[Which room has the tiger?]
    ...
    as shown below in \Cref{fig:pi-2022-4-p8}.
    \begin{figure}[h]
        \centering
        \begin{tabular}{|c|c|c|}
        \hline
