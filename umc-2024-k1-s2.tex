...
\begin{frame}[t]
    ...
    \[
        AB + BA_2 = AB + BC_2 = AC_2 = AB_2 = AC + CB_2 = AC + CA_2.
    \]}
...
\begin{frame}[t]
    ...
    Then by ($\Rightarrow$) $XB^2 - XC^2 + XC^2 - XA^2 + RA^2 - RB^2 = 0,$ or $XB^2 - XA^2 = RB^2 - RA^2,$
...
\begin{frame}[t]
    ...
    \begin{center}
        \begin{overprint}
            \onslide<1>\centering\includegraphics[width=5cm]{./svg/pdf/24-25-s7-g3-p3-0.pdf}
            \onslide<2->\centering\includegraphics[width=5cm]{./svg/pdf/24-25-s7-g3-p3.pdf}
        \end{overprint}        
    \end{center}  
...
\begin{frame}[t]
    ...
    \end{center}
    \begin{overprint}
        \onslide<2>Let $M$ be the intersection of $AI$ and the circle $(O),$ $M \not \equiv A.$ See above on the right.
        \[
