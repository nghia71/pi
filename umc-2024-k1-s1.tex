...
\begin{frame}[t]
    ...
    \begin{center}
        \begin{overprint}
            \onslide<1>\centering\includegraphics[width=4cm]{./svg/pdf/hc-2021-sm2-s2-p3-3.pdf}
            \onslide<2->\centering\includegraphics[width=4cm]{./svg/pdf/hc-2021-sm2-s2-p3-4.pdf}
        \end{overprint}        
    \end{center}    
    \onslide<2->{Let $N'$ be the reflection of $N$ over $O$.}
    \onslide<3->{$\triangle AON \cong \triangle CON'$ by SAS, so $AN=CN'$.}

    \onslide<4->{$\angle MCN' = \angle MCO + \angle OCN' = \angle BCA + \angle CAB = 90\dg$.
    Therefore, $\triangle MCN'$ is a right triangle.}
...
\begin{frame}[t]
    ...
    \begin{center}
        \begin{overprint}
            \onslide<1>\centering\includegraphics[width=5cm]{./svg/pdf/hc-2021-sm2-s1-p6-3.pdf}
            \onslide<2->\centering\includegraphics[width=5cm]{./svg/pdf/hc-2021-sm2-s1-p6-2.pdf}
        \end{overprint}        
    \end{center}
    \onslide<2->{Let $B'$ and $C'$ be the reflections of $A$ over lines $BE$ and $CD$, respectively.}
    
    \onslide<3->{\[ \angle B'AC + \angle C'CA = 2 \cdot 36\dg + 2 \cdot 54 \dg =  180\dg \Rightarrow CC' \parallel AB'.\]}
...
\begin{frame}[t]
    ...
    \begin{center}
        \begin{overprint}
            \onslide<1>\centering\includegraphics[width=6cm]{./svg/pdf/pct-2021-3-4-3-2-0.pdf}
            \onslide<2->\centering\includegraphics[width=6cm]{./svg/pdf/pct-2021-3-4-3-2-1.pdf}
        \end{overprint}        
    \end{center}
    \onslide<2->{Let $B'$ be the reflection of $B$ across $CD$.}
    \onslide<3->{$\angle DAC+\angle CB'D=180^\circ,$ so $ACB'D$ is cyclic. $AD=BC=CB',$ thus $\arc{AD} = \arc{B'C}.$}
...
\begin{frame}[t]
    ...
    \begin{center}
        \begin{overprint}
            \onslide<1>\centering\includegraphics[width=8cm]{./svg/pdf/pct-2021-3-5-4-2-0.pdf}
            \onslide<2->\centering\includegraphics[width=9cm]{./svg/pdf/pct-2021-3-5-4-2-1.pdf}
        \end{overprint}        
    \end{center}
    \onslide<2->{Let $M$ be the midpoint of $AB,$ $F$ be the intersection of the circle centred $M$ diameter $AB.$ 
    $AGB \le 90\dg$ so $G$ is outside the circle $(M)$, therefore $GM \ge FM= \half AB.$}

    \onslide<3->{Let $D$ be the reflection of $C$ over $M$. In triangle $DAC$, $DA+AC>DC \Rightarrow AC + CB>2CM.$}
    
    \onslide<4->{Therefore $AB \le 2 GM = \frac{2}{3} CM < \frac{1}{3} (AC + CB),$ thus $AC + CB>3AB.$}

    \onslide<5->{If $AC = BC,$ $G$ on circle $(M)$, then $AC + CB=\sqrt{10}AB<4AB.$ Thus, \framebox{$n=3.$}}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{center}
        \begin{overprint}
            \onslide<1>\centering\includegraphics[width=4.5cm]{./svg/pdf/24-25-t4-p20.pdf}
    ...
    \onslide<4->{Therefore the minimal length of the original curve is the perimeter of a circle area three times of an unit equilateral triangle.}
\end{frame}
...
\begin{frame}[t]
    ...
    \onslide<5->{Thus, $OA'=CA',$ $OB=B'D.$}
    \onslide<6->{Hence, \[ AB=A'B'=A'C+B'D=A'E-CE+B'E-DE=AE-ED+BE-EC=AD+BC.\]}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{center}
        \begin{overprint}
            \onslide<1>\centering\includegraphics[width=3cm]{./svg/pdf/24-25-t4-p8-0.pdf}
            \onslide<2->\centering\includegraphics[width=5cm]{./svg/pdf/24-25-t4-p8.pdf}
        \end{overprint}        
    \end{center}
...
\begin{frame}[t]
    ...
    \begin{center}
        \begin{overprint}
            \onslide<1>\centering\includegraphics[width=7cm]{./svg/pdf/24-25-t3-p15-0.pdf}
            \onslide<2->\centering\includegraphics[width=7cm]{./svg/pdf/24-25-t3-p15.pdf}
        \end{overprint}        
    \end{center}
    \begin{overprint}
...
\begin{frame}[t]
    ...
    \begin{center}
        \begin{overprint}
            \onslide<1>\centering\includegraphics[width=8cm]{./svg/pdf/canada-mo-1997-4-0.pdf}
            \onslide<2->\centering\includegraphics[width=8cm]{./svg/pdf/canada-mo-1997-4-1.pdf}
        \end{overprint}        
    \end{center}
...
\begin{frame}[t]
    ...
    \begin{center}
        \begin{overprint}
            \onslide<1>\centering\includegraphics[width=5cm]{./svg/pdf/imo-1978-4-0.pdf}
